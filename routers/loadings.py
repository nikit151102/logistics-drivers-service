...
async def add_loading_to_route(
    ...
    try:
        ...
        await log_system_error(
            ...
            section="loadings",
            request=request,
            component_name="add_loading_to_route",
            additional_metadata={}
        )
...
async def get_route_loadings(route_id: UUID, 
                            db: AsyncSession = Depends(get_session), 
                            request: Request = None):
    try:
        result = await db.execute(
        ...
        await log_system_error(
            ...
            section="loadings",
            request=request,
            component_name="get_route_loadings",
            additional_metadata={}
        )
        raise HTTPException(status_code=500, detail="Внутренняя ошибка сервера")
...
async def get_my_route_loadings(
    ...
    try:
        ...
        await log_system_error(
            ...
            section="loadings",
            request=request,
            component_name="get_my_route_loadings",
            additional_metadata={}
        )
        raise HTTPException(status_code=500, detail="Внутренняя ошибка сервера")
...
async def get_loading_by_id(loading_id: UUID, 
                            db: AsyncSession = Depends(get_session), 
                            request: Request = None):
    try:
        result = await db.execute(
        ...
        await log_system_error(
            ...
            section="loadings",
            request=request,
            component_name="get_loading_by_id",
            additional_metadata={}
        )
        raise HTTPException(status_code=500, detail="Внутренняя ошибка сервера")
...
async def delete_loading(loading_id: UUID, 
                         db: AsyncSession = Depends(get_session), 
                         request: Request = None):
    try:
        result = await db.execute(select(Loading).where(Loading.id == loading_id))
...
async def get_loading_logs(loading_id: UUID, 
                           db: AsyncSession = Depends(get_session), 
                           request: Request = None):
    try:
        ...
        await log_system_error(
            ...
            section="loadings",
            request=request,
            component_name="get_loading_logs",
            additional_metadata={}
        )
        raise HTTPException(status_code=500, detail="Внутренняя ошибка сервера")
...
async def add_loading_log(
    ...
    try:
        ...
        await log_system_error(
            ...
            section="loadings",
            request=request,
            component_name="add_loading_log",
            additional_metadata={}
        )
        raise HTTPException(status_code=500, detail="Внутренняя ошибка сервера")
...
async def update_loading_status(
    ...
    try:
        ...
        await log_system_error(
            ...
            section="loadings",
            request=request,
            component_name="update_loading_status",
            additional_metadata={}
        )
        raise HTTPException(status_code=500, detail="Внутренняя ошибка сервера")
